...
PublicInfoUserResponse publicInfoUserResponseFromJson(String str) => PublicInfoUserResponse.fromJson(json.decode(str));

String publicInfoUserResponseToJson(PublicInfoUserResponse data) => json.encode(data.toJson());
...
class PublicInfoUserResponse {
    ...
    factory PublicInfoUserResponse.fromJson(Map<String, dynamic> json) => PublicInfoUserResponse(
        ok: json["ok"],
